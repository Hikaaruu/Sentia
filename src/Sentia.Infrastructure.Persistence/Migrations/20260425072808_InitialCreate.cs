        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    ChatId = table.Column<long>(type: "bigint", nullable: false),
                    LastReadMessageId = table.Column<string>(type: "nvarchar(40)", nullable: true),
                    ReadAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatReadStatus", x => new { x.UserId, x.ChatId });
                    table.ForeignKey(
                        name: "FK_ChatReadStatus_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatReadStatus_Messages_LastReadMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatReadStatus_ChatId",
                table: "ChatReadStatus",
                column: "ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatReadStatus_LastReadMessageId",
                table: "ChatReadStatus",
